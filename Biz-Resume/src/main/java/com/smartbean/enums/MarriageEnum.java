...
public enum MarriageEnum {
     ...
     */
    MarriageEnum(String code, String dbValue, String description) {
        this.code = code;
     ...
     * @return 结果枚举对象
     */
    public static MarriageEnum get(String code) {
        if ("".equals(code) || code == null) {
            throw new RuntimeException("编码不存在！");
        }
        MarriageEnum[] list = values();
        for (MarriageEnum customerType : list) {
